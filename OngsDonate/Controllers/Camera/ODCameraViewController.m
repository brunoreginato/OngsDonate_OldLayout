//
//  ODCameraViewController.m
//  OngsDonate
//
//  Created by Bruno Isola Reginato on 10/14/15.
//  Copyright (c) 2015 ong. All rights reserved.
//

#import "ODCameraViewController.h"

@interface ODCameraViewController ()
...
@implementation ODCameraViewController
{
...
-(void)roundButton {
    [self.takePictureButton.layer setMasksToBounds:YES];
    [self.takePictureButton.layer setCornerRadius:self.takePictureButton.frame.size.height/2];
}
